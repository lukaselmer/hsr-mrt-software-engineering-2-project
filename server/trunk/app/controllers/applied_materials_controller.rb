# The AppliedMaterialsController is responsible to manager the materials that were used in an order. It supports the CRUD operations for the AppliedMaterial although its basic functionallity has been implemented inline in the orders controller
